...
### *Comprehensive Data Structures & Algorithms Lab — Weeks 1 to 5*
**VTU Student ID: `VTU29661`**

[![Total Solved](https://img.shields.io/badge/Total_Solved-45%2F45-6366f1?style=for-the-badge&logo=leetcode&logoColor=white)](https://leetcode.com/)
...
[![Easy](https://img.shields.io/badge/🟢_Easy-25-10b981?style=for-the-badge)](https://leetcode.com/)
[![Medium](https://img.shields.io/badge/🟡_Medium-17-f59e0b?style=for-the-badge)](https://leetcode.com/)
[![Hard](https://img.shields.io/badge/🔴_Hard-3-ef4444?style=for-the-badge)](https://leetcode.com/)
[![Status](https://img.shields.io/badge/Status-Weeks_1--5_Complete-success?style=for-the-badge)](https://github.com/)

<p align="center">
  A production-ready, benchmarked collection of optimal Java solutions for the <b>Applied Coding Skills (S1L10)</b> course at VTU. Covering core data structures and algorithmic patterns across 5 intensive modules: Arrays, Two Pointers, Linked Lists, Stacks, Monotonic Deques, Circular Ring Buffers, Breadth-First Search (BFS), Binary Tree Traversals, Depth-First Search (DFS), Path Backtracking, and Interval Sweeping.
</p>
...
- [📅 Week 5: Binary Trees, Depth-First Search (DFS) & Tree Traversals](#-week-5-binary-trees-depth-first-search-dfs--tree-traversals)
...
| **Week 5** | Binary Trees, DFS Traversals, Path Backtracking & Interval Sweeps | 7 | 2 | 0 | **9** | ![Completed](https://img.shields.io/badge/100%25-Complete-brightgreen?style=flat-square) | [Browse Week 5](./Week-5/README.md) |
| **Total** | **All 5 Modules** | **25** | **17** | **3** | **45** | ![Complete](https://img.shields.io/badge/45%2F45-100%25-6366f1?style=flat-square) | — |

### 🎯 Overall Difficulty Distribution

```
🟢 Easy       [25 Solved]  ████████████████████████████ 55.6%
🟡 Medium     [17 Solved]  ███████████████████          37.8%
🔴 Hard       [ 3 Solved]  ███                           6.7%
─────────────────────────────────────────────────────────────
Total: 45 Solved | 100% Java Solutions | All Test Cases Passed
```
...
│   └── 1438-longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit/# Dual monotonic deques (min/max)
└── 📁 Week-5/                                            # Week 5: Binary Trees, DFS Traversals & Interval Sweeps
    ├── 📄 README.md                                      # Week 5 overview & problem index
    ├── 0094-binary-tree-inorder-traversal/               # Recursive Inorder traversal (L-Root-R)
    ├── 0100-same-tree/                                   # Dual-tree structural recursion
    ├── 0101-symmetric-tree/                              # Mirror reflection recursive validation
    ├── 0112-path-sum/                                    # Target sum reduction via DFS
    ├── 0113-path-sum-ii/                                 # Backtracking DFS root-to-leaf path collection
    ├── 0144-binary-tree-preorder-traversal/              # Iterative Preorder traversal with Stack
    ├── 0145-binary-tree-postorder-traversal/             # Recursive Postorder traversal (L-R-Root)
    ├── 0257-binary-tree-paths/                           # Root-to-leaf string path construction
    └── 0986-interval-list-intersections/                 # Two-pointer interval sweep & overlap
```
...
| 0206 | [Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Iterative 3-Pointer Reversal | $O(N)$ | $O(1)$ | `0 ms (100.00%)` | [solution.java](./Week-2%20/0206-reverse-linked-list/solution.java) | [README.md](./Week-2%20/0206-reverse-linked-list/README.md) |
| 0234 | [Palindrome Linked List](https://leetcode.com/problems/palindrome-linked-list/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Fast/Slow Pointers + Half Reversal | $O(N)$ | $O(1)$ | `3 ms (99.83%)` | [solution.java](./Week-2%20/0234-palindrome-linked-list/solution.java) | [README.md](./Week-2%20/0234-palindrome-linked-list/README.md) |
| 0876 | [Middle of the Linked List](https://leetcode.com/problems/middle-of-the-linked-list/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Fast/Slow Pointer (Midpoint) | $O(N)$ | $O(1)$ | `0 ms (100.00%)` | [solution.java](./Week-2%20/0876-middle-of-the-linked-list/solution.java) | [README.md](./Week-2%20/0876-middle-of-the-linked-list/README.md) |
...
> **Focus:** Hierarchical tree representations, recursive vs. iterative DFS traversals (Inorder, Preorder, Postorder), explicit stack simulation, dual-tree structural equivalence, mirror symmetry validation, root-to-leaf path backtracking, target sum path accumulation, and two-pointer interval sweeps.  
> 🔗 **Module Link:** [Detailed Week 5 Documentation](./Week-5/README.md)

| # | Problem Title | Difficulty | Key Pattern / Concept | Time | Space | Performance | Solution | Notes |
| :---: | :--- | :---: | :--- | :---: | :---: | :---: | :---: | :---: |
| 0094 | [Binary Tree Inorder Traversal](https://leetcode.com/problems/binary-tree-inorder-traversal/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Tree Traversal (L-Root-R) / Recursive DFS | $O(N)$ | $O(H)$ | `0 ms (100.00%)` | [solution.java](./Week-5/0094-binary-tree-inorder-traversal/solution.java) | [README.md](./Week-5/0094-binary-tree-inorder-traversal/README.md) |
| 0100 | [Same Tree](https://leetcode.com/problems/same-tree/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Structural Recursion / Dual Tree DFS | $O(N)$ | $O(H)$ | `0 ms (100.00%)` | [solution.java](./Week-5/0100-same-tree/solution.java) | [README.md](./Week-5/0100-same-tree/README.md) |
| 0101 | [Symmetric Tree](https://leetcode.com/problems/symmetric-tree/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Mirror Reflection Recursion / Dual DFS | $O(N)$ | $O(H)$ | `0 ms (100.00%)` | [solution.java](./Week-5/0101-symmetric-tree/solution.java) | [README.md](./Week-5/0101-symmetric-tree/README.md) |
| 0112 | [Path Sum](https://leetcode.com/problems/path-sum/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Root-to-Leaf Target Sum Reduction / DFS | $O(N)$ | $O(H)$ | `0 ms (100.00%)` | [solution.java](./Week-5/0112-path-sum/solution.java) | [README.md](./Week-5/0112-path-sum/README.md) |
| 0113 | [Path Sum II](https://leetcode.com/problems/path-sum-ii/) | ![Medium](https://img.shields.io/badge/Medium-yellow?style=flat-square) | Backtracking DFS / Path Accumulation | $O(N)$ | $O(H)$ | `1 ms (99.99%)` | [solution.java](./Week-5/0113-path-sum-ii/solution.java) | [README.md](./Week-5/0113-path-sum-ii/README.md) |
| 0144 | [Binary Tree Preorder Traversal](https://leetcode.com/problems/binary-tree-preorder-traversal/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Iterative DFS / Explicit Stack (Root-L-R) | $O(N)$ | $O(H)$ | `1 ms (6.65%)` | [solution.java](./Week-5/0144-binary-tree-preorder-traversal/solution.java) | [README.md](./Week-5/0144-binary-tree-preorder-traversal/README.md) |
| 0145 | [Binary Tree Postorder Traversal](https://leetcode.com/problems/binary-tree-postorder-traversal/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Tree Traversal (L-R-Root) / Recursive DFS | $O(N)$ | $O(H)$ | `0 ms (100.00%)` | [solution.java](./Week-5/0145-binary-tree-postorder-traversal/solution.java) | [README.md](./Week-5/0145-binary-tree-postorder-traversal/README.md) |
| 0257 | [Binary Tree Paths](https://leetcode.com/problems/binary-tree-paths/) | ![Easy](https://img.shields.io/badge/Easy-brightgreen?style=flat-square) | Root-to-Leaf Path Traversal / Backtracking | $O(N)$ | $O(H)$ | `2 ms (82.67%)` | [solution.java](./Week-5/0257-binary-tree-paths/solution.java) | [README.md](./Week-5/0257-binary-tree-paths/README.md) |
| 0986 | [Interval List Intersections](https://leetcode.com/problems/interval-list-intersections/) | ![Medium](https://img.shields.io/badge/Medium-yellow?style=flat-square) | Two Pointers / Interval Range Overlap | $O(N + M)$ | $O(1)$ | `4 ms (51.35%)` | [solution.java](./Week-5/0986-interval-list-intersections/solution.java) | [README.md](./Week-5/0986-interval-list-intersections/README.md) |
...
graph TD
    ...
    A --> E[Queues & BFS]
    A --> F[Binary Trees & DFS]
    A --> G[Intervals & Sweep-Line]
    ...
    F --> F1[Pre / In / Postorder Traversals]
    F --> F2[Explicit Stack Iterative DFS]
    F --> F3[Dual-Tree Structural Equivalence & Mirror Reflection]
    F --> F4[Root-to-Leaf Path Backtracking]

    G --> G1[Two-Pointer Interval Overlap Detection]
```
...
- Interval pointer advancement in **Interval List Intersections (0986)** synchronizing two disjoint sorted sequences.
...
### 7. Binary Tree Depth-First Search (DFS) & Tree Traversals
- **Standard Traversal Sequences:** Leverages recursive Depth-First Search for Inorder (`Left -> Root -> Right`) in **Binary Tree Inorder Traversal (0094)** and Postorder (`Left -> Right -> Root`) in **Binary Tree Postorder Traversal (0145)** with $O(H)$ auxiliary call-stack space.
- **Iterative DFS via Explicit Stack:** Eliminates recursion stack limits in **Binary Tree Preorder Traversal (0144)** by simulating Call Stacks using `Stack<TreeNode>` pushing right before left children (`Root -> Left -> Right`).
- **Structural Tree Equivalence:** Confirms identical topology and node value parity simultaneously in **Same Tree (0100)** via dual-tree recursive matching.
- **Bilateral Mirror Symmetry:** Compares mirrored subtrees across bilateral tree axes (`t1.left == t2.right` and `t1.right == t2.left`) in **Symmetric Tree (0101)**.

### 8. Backtracking & Root-to-Leaf Path Accumulation
- **Target Sum Validation:** Propagates remainder targets down recursive branches in **Path Sum (0112)** to confirm path totals equal target values at leaf nodes.
- **Full Path Collection:** Gathers all qualifying path lists in **Path Sum II (0113)** using an active path accumulator with clean backtracking (`currentPath.remove(currentPath.size() - 1)`).
- **String Path Construction:** Dynamically builds `Root->Node->Leaf` string representations across tree depths in **Binary Tree Paths (0257)**.

### 9. Interval Sweeping & Two-Pointer Intersections
- Computes pairwise overlapping intervals via `[max(start1, start2), min(end1, end2)]` in **Interval List Intersections (0986)**, advancing the pointer with the earlier ending bound in $O(N + M)$ time.
...
# Example 4: Week 5 - Binary Tree Inorder Traversal
cd ../../Week-5/0094-binary-tree-inorder-traversal
javac solution.java

# Example 5: Week 5 - Path Sum II
cd ../0113-path-sum-ii
javac solution.java
```
